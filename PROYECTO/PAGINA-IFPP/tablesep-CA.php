...
<body>
    <div class="container">
        <table class="table">
            <caption> Estadía Profesional: Carta de Aceptación </caption>
            <thead>
                <tr>
                <th>ID</th>
                    <th>Directivo</th>
            ...
            <?php
                ...
                $consulta = "SELECT * FROM cartaaceptacionep LIMIT $inicio, $registrosPorPagina";
                ...
                $resultado = mysqli_query($getconex, $consulta);
                    ...
                    $consultaTotal = "SELECT COUNT(*) as total FROM cartaaceptacionep";
  ...
  botonesSeleccionar.forEach(function (boton) {
    boton.addEventListener('click', function () {
      ...
      window.location.href = 'G_Doc_EP_CA.php?id=' + idSeleccionado;
    });
  });
</script>
