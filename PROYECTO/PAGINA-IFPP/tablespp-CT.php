...
<body>
    <div class="container">
        <table class="table">
            <caption> Prácticas Profesionales: Carta de Terminación </caption>
            <thead>
                <tr>
                <th>ID</th>
                    <th>Directivo</th>
            ...
            <?php
                ...
                $consulta = "SELECT * FROM cartaterminacionpp LIMIT $inicio, $registrosPorPagina";
                ...
                $resultado = mysqli_query($getconex, $consulta);
                    ...
                    $consultaTotal = "SELECT COUNT(*) as total FROM cartaterminacionpp";
  ...
  botonesSeleccionar.forEach(function (boton) {
    boton.addEventListener('click', function () {
      ...
      window.location.href = 'G_Doc_PP_CT.php?id=' + idSeleccionado;
    });
  });
</script>
