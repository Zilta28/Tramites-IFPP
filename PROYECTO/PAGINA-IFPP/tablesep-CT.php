...
<head>
    ...
    <title>Estadía Profesional</title>
...
<body>
    <div class="container">
        <table class="table">
            <caption> Estadía Profesional: Carta de Terminación </caption>
            <thead>
                <tr>
                <th>ID</th>
                    <th>Directivo</th>
            ...
            <?php
                ...
                $consulta = "SELECT * FROM cartaterminacionep LIMIT $inicio, $registrosPorPagina";
                ...
                $resultado = mysqli_query($getconex, $consulta);
                    ...
                    $consultaTotal = "SELECT COUNT(*) as total FROM cartaterminacionep";
  ...
  botonesSeleccionar.forEach(function (boton) {
    boton.addEventListener('click', function () {
      ...
      window.location.href = 'G_Doc_EP_CT.php?id=' + idSeleccionado;
    });
  });
</script>
